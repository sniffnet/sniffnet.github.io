...
share-description: "How Sniffnet got its own website, nine months after the first commit, and the community milestones that led there."
nav-title: News
...
<div align="center">
<img alt="The Sniffnet logo and name on a dark blue background" src="{{ 'assets/img/preview.png' | relative_url }}" width="100%"/>
</div>

_Originally posted on <a target="_blank" rel="noopener" href="https://github.com/GyulyVGC/sniffnet/discussions/239">GitHub Discussions</a>._
