...
share-description: "Sniffnet v1.2 shifts network traffic analysis from an IP-address-based approach to a host-based one, with domain names, ASN and geolocation."
nav-title: News
