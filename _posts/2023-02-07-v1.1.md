...
share-description: "Sniffnet v1.1 adds IP geolocation of remote hosts via MaxMind MMDB files, custom notifications for network events, and in-app settings."
nav-title: News
