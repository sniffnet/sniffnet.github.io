...
share-description: "Sniffnet v1.0 brings a full graphical user interface, letting you glance at your network traffic without the complexity of traditional analysers."
nav-title: News
...
Sniffnet is a network analyser (packet sniffer) developed with the aim to let people have a glance into their network traffic **without pain, in a simple and clear way**: to this purpose, the last release of the application introduces a whole friendly GUI (made with <a target="_blank" rel="noopener" href="https://iced.rs">iced</a>).

<div align="center">
    <img  width="100%" alt="Sniffnet v1.0 graphical user interface showing live traffic charts and network statistics" title="Sniffnet GUI" src="{{ 'assets/img/post/v1.0/cover.png' | relative_url }}"/><br><br>
</div>
...
_Originally posted on <a target="_blank" rel="noopener" href="https://www.reddit.com/r/rust/comments/z10aoj/sniffnet_finally_has_a_gui_an_application_to/">Reddit</a>._
