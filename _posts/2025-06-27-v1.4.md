...
share-description: "Sniffnet v1.4 adds PCAP file import — analyse existing captures offline, 2X faster than Wireshark — alongside performance and reliability improvements."
nav-title: News
...
<a target="_blank" rel="noopener" href="https://greenlab.di.uminho.pt/wp-content/uploads/2017/09/paperSLE.pdf">
    <img style="padding-left: 10px" align="right" alt="Table ranking programming languages by relative execution speed, with C at 1.00 and Rust second at 1.04" title="Relative speed of different programming languages executing a set of standard algorithmic problems" src="{{ 'assets/img/post/v1.4/bench.png' | relative_url }}">
</a>
...
Additionally, Sniffnet uses the <a target="_blank" rel="noopener" href="https://github.com/rust-pcap/pcap">_pcap_</a> crate to process data, which is just a Rust binding library to <a target="_blank" rel="noopener" href="https://github.com/the-tcpdump-group/libpcap">_libpcap_</a> (the same underlying engine used by Wireshark).<br>
...
Considering that nowadays more than <a target="_blank" rel="noopener" href="https://transparencyreport.google.com/https/overview">90% of the web traffic uses TLS</a>, this strategy enables having huge performance gains without losing much relevant information:
...
<div align="center">
<img alt="Sniffnet notifications page listing favourite-host and bytes-threshold events with timestamps, country flags and data volumes" class="paddedGalleryImg myShadow" title="Notifications page" width="80%" src="{{ 'assets/img/post/v1.4/notifications_page.png' | relative_url }}">
</div>

_These are just some of the most relevant changes introduced in this release.<br>
For more details, you can check the <a target="_blank" rel="noopener" href="https://github.com/GyulyVGC/sniffnet/releases/tag/v1.4.0">release page</a> on GitHub._
